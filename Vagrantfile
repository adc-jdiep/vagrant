...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.define "puppet" do |puppet_config|
    puppet_config.vm.box = "puppetlabs/centos-6.6-64-puppet"
  ...
  config.vm.define "jd" do |jd_config|
    jd_config.vm.box = "puppetlabs/centos-6.6-64-puppet"
  ...
  config.vm.define "gitlab" do |gitlab_config|
    gitlab_config.vm.box = "puppetlabs/centos-6.6-64-puppet"
  ...
  config.vm.define "nodejs" do |nodejs_config|
    nodejs_config.vm.box = "puppetlabs/centos-6.6-64-puppet"
  ...
  config.vm.define "node1" do |node1_config|
    node1_config.vm.box = "puppetlabs/centos-6.6-64-puppet"
  ...
  config.vm.define "docker" do |docker_config|
    ...
    docker_config.vm.box = "puppetlabs/centos-6.6-64-puppet"
    docker_config.image="centos"
